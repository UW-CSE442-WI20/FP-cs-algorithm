...
var width = 1650;
var height = 530; // width not raidus... too lazy to change
...
function updateVis() {
  ...
  svg.selectAll(".person-circle").data(personData).attr("xlink:href", function (d) {
